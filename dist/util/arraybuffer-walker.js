...
class ArrayBufferWalker {
    ...
    writeCRC() {
        ...
        let crc = (0, crc_1.crc32)(this.array, this.crcStartOffset, this.offset - this.crcStartOffset);
    ...
    pauseAdler() {
        ...
        this.savedAdlerValue = (0, adler_1.adler32_buf)(this.array, this.adlerStartOffset, this.offset - this.adlerStartOffset, this.savedAdlerValue);
    ...
    writeAdler(walker) {
        ...
        let adler = (0, adler_1.adler32_buf)(this.array, this.adlerStartOffset, this.offset - this.adlerStartOffset, this.savedAdlerValue);
        this.adlerStartOffset = undefined;
